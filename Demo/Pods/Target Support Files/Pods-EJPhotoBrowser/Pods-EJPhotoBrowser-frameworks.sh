...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EJTools/EJTools.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EJWarningCardView/EJWarningCardView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LSToolsKit/LSToolsKit.framework"
