...
//    CGSize imgSize = [UIImageView downloadJpgImage:urlStr];
    CGSize imgSize = [self originalWebImageSizeWithURLStr:urlStr];
    
//    CGFloat resultW = imgSize.width;
//    CGFloat resultH = imgSize.height;
//    if ((resultW / resultH) > ratio || ((resultW / resultH) < 1 && (resultW / resultH) > (1 / ratio))) {
//        resultW = ceil(maxW / 2.f);
//        resultH = resultW * ratio;
//        imgSize = CGSizeMake(resultW, resultH);
//    }
...
//        strUrl = [[strUrl componentsSeparatedByString:@"?"] firstObject];
//        if (![strUrl containsString:@"@100p"]) {
//            strUrl = [strUrl stringByAppendingString:@"@100p"];
