...
// Notifications
#define EJPHOTO_LOADING_DID_END_NOTIFICATION @"EJPHOTO_LOADING_DID_END_NOTIFICATION"
#define EJPHOTO_PROGRESS_NOTIFICATION @"EJPHOTO_PROGRESS_NOTIFICATION"
...
// Otherwise you can use the EJPhoto object or subclass it yourself to
// store more information per photo.
//
// You can see the EJPhoto class for an example implementation of this protocol
//
@protocol EJPhoto <NSObject>
...
// See EJPhoto object for an example implementation.
